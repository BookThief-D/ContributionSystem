		...
		<tr>
			<td>
				<div class="table_box2">
					<form id="mainform" name="mainform" action="isjudge.action"
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<td colspan="2"><div class="table">
										...
										<table width="100%" border="0" align="center" cellpadding="0"
											...
											<tr>
												...
												<td align="left"><select id="updateTime"
													name="updateTime">
							...
							<tr>
								<td align="center" colspan="2"><input class="btn big"
									type="submit" style="font-size:12px;height:24px;" value="确认审核" />
									<a class="btn big" href="review.jsp" target="main"
