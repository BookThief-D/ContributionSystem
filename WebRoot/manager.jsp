...
<frameset cols="200,*,200" frameborder="no">
	...
	<frameset rows="150,*" frameborder="no">
		...
		<frameset cols="200,*">
			<frame name="left" src="manager/managerinfo.jsp" noresize="noresize"
				scrolling="no" frameborder="no">
			<frame name="main" src="manager/alteruserinfo.jsp"
				noresize="noresize" scrolling="no" frameborder="no">
		</frameset>
